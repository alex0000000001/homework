...
namespace homework.NWDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cityname", global::System.Data.SqlDbType.NVarChar, 15, global::System.Data.ParameterDirection.Input, 0, 0, "City", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByFindcityname(NWDataSet.CustomersDataTable dataTable, string cityname) {
        ...
        public virtual NWDataSet.CustomersDataTable GetDataBy(string cityname) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((cityname == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT  ProductID, ProductName, CategoryID, UnitPrice, Discontinued\r\nFROM      Pr" +
            ...
            this._commandCollection[2].CommandText = "SELECT  ProductID, ProductName, CategoryID, UnitPrice, Discontinued\r\nFROM      Pr" +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByKeyWord(NWDataSet.ProductsDataTable dataTable, string ProductName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((ProductName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySelectPrice(NWDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> Price1, global::System.Nullable<decimal> Price2) {
